...
public class SubtractPolynomials {
    ...
    public SubtractPolynomials(String poly_v6, String polly_v11) {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int i = 0; i < polyPairs.length; i++) {
            ...
            /* Add the polys */
            polyfun.Polynomial sum_v6 = polynomial_v6.minus(polynomial_v6_2);
            Polynomial sum_v11 = polynomial_v11.minus(polynomial_v11_2);
